...
public class Logout_Account {
  ...
  @Test(description = "Login account", priority = 1)
  public void Login() {
...
//	  verify login successfully
  ...
  public void Logout(){
//	  click link text account
	  driver.findElement(By.xpath("//*[@id=\"header\"]/div/div[2]/div/a")).click();
	  
//	  actions link text log out
	  Actions actions_2 = new Actions(driver);
	  WebElement element2= driver.findElement(By.xpath("//*[@id=\"header-account\"]/div/ul/li[5]/a"));
	  actions_2.click(element2).build().perform();
